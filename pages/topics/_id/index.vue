                ...
                <p>{{content.body}}</p>
                     ...
                     <div v-if="authenticated">
                         ...
                         <div v-if="user.id === content.user.id ">
                             ...
                             <button @click="deletePost(content.id)" class="btn btn-outline-danger fa fa-trash fa-2x pull-right"></button>
        ...
        <div class="mt-5 ml-5 mb-5" v-if="authenticated">
            <form @submit.prevent="create">
                <div class="form-group">
                    ...
                    <textarea v-model="body" placeholder="write something..." class="form-control" rows="5"></textarea>
